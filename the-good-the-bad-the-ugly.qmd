...
title-slide-attributes: 
   ...
   data-background-size: 450px, cover
   data-background-position: 50% 15%, center
server: shiny
---
...
At $k =0$, $TIF^0 = (0, 0, \ldots, 0)$, $Q^0 = \emptyset$, iterate


1. $A^k = B \setminus Q^k$

2. $\forall i \in A^k$, $PIF_{i}^k = \frac{TIF^k + IIF_{i}}{||Q^k||+1}$

3. $D = \arg \min_{i \in A^k} |TIF^* - PIF_i^k|$

Termination criterion: $|TIF^* - PIF_D^{k}| \geq |TIF^* - TIF^{k-1}|$: 
